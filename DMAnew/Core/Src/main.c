...
const uint8_t flashData[100] __attribute__((aligned(4))) ={
...
uint8_t ramData[100] __attribute__((aligned(4)));
/* USER CODE END 0 */
...
//    __HAL_TIM_SET_COUNTER(&htim16 , 0);
//    HAL_TIM_Base_Start(&htim16);
//    HAL_I2C_Mem_Read_DMA(&hi2c1, 208, 0, 1, ramData, 64);
//
//    while(flag == 0){
//  	  counter++;
//    }
