...
/* Definitions for brightnessQueue */
osMessageQueueId_t brightnessQueueHandle;
const osMessageQueueAttr_t brightnessQueue_attributes = {
  .name = "brightnessQueue"
};
/* USER CODE BEGIN PV */
...
/* USER CODE BEGIN Header_Entry_blinkTask */
/**
* @brief Function implementing the blinkTask thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_Entry_blinkTask */
__weak void Entry_blinkTask(void *argument)
{
...
/* USER CODE BEGIN Header_Entry_commTask */
/**
* @brief Function implementing the commTask thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_Entry_commTask */
__weak void Entry_commTask(void *argument)
{
  /* USER CODE BEGIN Entry_commTask */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END Entry_commTask */
}
